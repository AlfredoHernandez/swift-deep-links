...
struct DeepLinkCoordinatorDelegateFactoryTests {
    ...
    func analytics_factoryMethod_createsDelegateWithCorrectType() async throws {
    ...
    func logging_factoryMethod_createsDelegateWithCorrectType() async throws {
    ...
    func logging_factoryMethodWithDebugEnabled_createsDelegate() async throws {
    ...
    func notification_factoryMethod_createsDelegateWithCorrectType() async throws {
    ...
    func notification_factoryMethodWithAllParameters_createsDelegate() async throws {
        let delegate: any DeepLinkCoordinatorDelegate = .notification(
            showSuccess: true,
            showErrors: true,
            showInfo: true,

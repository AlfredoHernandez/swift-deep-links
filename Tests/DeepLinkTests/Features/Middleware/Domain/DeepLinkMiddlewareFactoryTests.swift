...
struct DeepLinkMiddlewareFactoryTests {
    ...
    func analytics_factoryMethod_createsMiddlewareWithCorrectType() async throws {
    ...
    func analytics_factoryMethodWithStrategy_createsMiddleware() async throws {
        let provider = DefaultAnalyticsProvider()
    ...
    func logging_factoryMethod_createsMiddlewareWithCorrectType() async throws {
    ...
    func logging_factoryMethodWithParameters_createsMiddleware() async throws {
        let middleware: any DeepLinkMiddleware = .logging(
    ...
    func rateLimit_factoryMethod_createsMiddlewareWithCorrectType() async throws {
    ...
    func rateLimit_factoryMethodWithParameters_createsMiddleware() async throws {
        let middleware: any DeepLinkMiddleware = .rateLimit(
            maxRequests: 5,
            timeWindow: 30.0,
    ...
    func security_factoryMethod_createsMiddlewareWithCorrectType() async throws {
    ...
    func security_factoryMethodWithAllParameters_createsMiddleware() async throws {
        let middleware: any DeepLinkMiddleware = .security(
    ...
    func authentication_factoryMethod_createsMiddlewareWithCorrectType() async throws {
    ...
    func authentication_factoryMethodWithStrategy_createsMiddleware() async throws {
        let provider = PermissiveAuthenticationProvider()
        let middleware: any DeepLinkMiddleware = .authentication(
            provider: provider,
            protectedHosts: [],
    ...
    func urlTransformation_factoryMethod_createsMiddlewareWithCorrectType() async throws {
    ...
    func urlTransformation_factoryMethodWithStrategy_createsMiddleware() async throws {
        let transformer = URLNormalizationTransformer()
    ...
    func factoryMethods_canBeUsedInArrays() async throws {
        let provider = DefaultAnalyticsProvider()

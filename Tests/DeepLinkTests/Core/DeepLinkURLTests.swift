...
struct DeepLinkURLTests {
	...
	func deepLinkURL_init_throwsInvalidURLErrorOnMalformedURL() throws {
	...
	func deepLinkURL_init_throwsInvalidURLErrorOnURLWithoutScheme() throws {
	...
	func deepLinkURL_init_throwsInvalidURLErrorOnEmptyURL() throws {
